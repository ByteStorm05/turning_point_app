  ...
  <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
    <div>
      ...
      <div className="mt-7 grid gap-3 w-full sm:inline-flex">
        <Link  href = '/courses' className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" >
          Explore Courses
    ...
    <div className="relative ms-4">
      ...
      <div className="absolute inset-0 -z-[1] bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6 dark:from-neutral-800 dark:via-neutral-900/0 dark:to-neutral-900/0"></div>
        ...
        {/* Why Turning Point Start */}
        <section className="bg-white dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="max-w-screen-md mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl font-extrabold text-gray-900 dark:text-white">Why Turning Point Institute is the <span className="text-green-500 underline">Optimal Choice</span> for Your Educational Needs</h2>
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Excellence</h3>
              <p className="text-gray-500 dark:text-gray-400">We excel in offering top-notch
coaching classes for IIT- JEE, AlIMS, NEET, and CBSE Examinations, led by renowned and highly acclaimed faculties.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">To maintain a personalized approach, we organize small batches that enable individual attention for each student.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">All these exceptional services are
available to deserving students at a highly reasonable fee.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Dedication</h3>
              <p className="text-gray-500 dark:text-gray-400">Our institute stands out by
providing dedicated and personalized counseling to every student, ensuring they receive the latest updated and well-researched study material.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Concept Clarity</h3>
              <p className="text-gray-500 dark:text-gray-400">We foster comprehension at every level through easily understandable lectures, with a special emphasis on addressing conceptual weaknesses.</p>
          </div>
      </div>
  </div>
</section>

        {/* Why Turning Point End */}
        
       

{/* From the director start */}
        <div className="mt-16 max-w-screen-md mx-auto text-center">
  <h2 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white">From the Director</h2>
  <p className="text-gray-500 sm:text-xl dark:text-gray-400 mb-8">
    Hear directly from our Director, Mr. T N Chowdhary about our vision, values, and the unique advantages of our institute. Watch these videos to get an inside look at what makes us different.
  </p>
  <div className="flex flex-col md:flex-row justify-center gap-8">
    <div className="w-full md:w-1/2">
      <iframe className="w-full h-48 md:h-60 rounded-lg border-2 border-gray-300 dark:border-gray-600" src="https://www.youtube.com/embed/hl6R91ORm94" title="Director's Message - T N Chowdhary - Turning Point Institute Paschim Vihar Delhi" frameBorder="0" allowFullScreen></iframe>
    </div>
    <div className="w-full md:w-1/2">
      <iframe className="w-full h-48 md:h-60 rounded-lg border-2 border-gray-300 dark:border-gray-600" src="https://www.youtube.com/embed/XCWhPCjQlV4" title="Expert Guide to Crack Medical and Engineering Exams India" frameBorder="0" allowFullScreen></iframe>
    </div>
  </div>
</div>

{/* From the director end */}
...
<footer className=" pt-52 bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="flex justify-center w-full items-center mb-6 md:mb-0">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Turning Point Institute Private Limited</a>. All Rights Reserved.
          </span>
